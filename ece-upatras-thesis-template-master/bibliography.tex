...
\bibitem{kalovrektis} Καλοβρέκτης Κωνσταντίνος. ``LabVIEW για Μηχανικούς, Συστήματα Συλλογής Δεδομένων, $3^η$ Έκδοση, Εκδόσεις Τζιόλα, ISBN 978-960-418-448-4.
...
\bibitem{vandoren} VanDoren, Vance (1 September 2009). ``Relay Method Automates PID Loop Tuning". Control Engineering.
\bibitem{ogata} Ogata, Katsuhiko. ``Modern Control Engineering", $5^{th}$ Edition : ISBN 0136156738.
\bibitem{mohammad} Mohammad A.K. Alia, Tariq M. Younes, Shebel A. Alsabbah. ``A Design of a PID Self--Tuning Controller Using LabVIEW", Journal of Software Engineering and Applications, 2011, 4, 161-171, doi:10.4236/jsea.2011.43018.
\bibitem{keithley} Raymond Rogers. ``Building a Benchtop PID Controller", Keithley Instruments, Inc.
